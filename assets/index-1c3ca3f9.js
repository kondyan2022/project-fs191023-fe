...
`,AO=()=>f.jsx(QL,{children:f.jsxs("a",{href:`${{}.VITE_BACKEND_URL}/users/google`,children:[f.jsx("svg",{children:f.jsx("use",{href:`${ge}#icon-google`})}),f.jsx("span",{children:"Sign in with Google"})]})}),VL=()=>f.jsx(Yp,{children:f.jsx(Vn,{children:f.jsxs(YL,{children:[f.jsx("h2",{children:"Create account"}),f.jsx(BL,{children:"Thank you for your interest in our platform. To complete the registration process, please provide us with the following information."}),f.jsx(WL,{}),f.jsx(AO,{}),f.jsxs(HL,{children:["Already have account? ",f.jsx(qL,{to:"/signin",children:" Sign In"})]}),f.jsx(wy,{}),f.jsx(by,{})]})})}),KL=Q.div`
  width: 100%;
  max-width: 286px;
  display: flex;
  flex-direction: column;
