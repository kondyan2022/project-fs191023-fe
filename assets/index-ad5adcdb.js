...
`,AO=()=>f.jsx(QL,{children:f.jsxs("a",{href:"https://power-plus-service-nest.onrender.com/users/google",children:[f.jsx("svg",{children:f.jsx("use",{href:`${ge}#icon-google`})}),f.jsx("span",{children:"Sign in with Google"})]})}),VL=()=>f.jsx(Yp,{children:f.jsx(Vn,{children:f.jsxs(YL,{children:[f.jsx("h2",{children:"Create account"}),f.jsx(BL,{children:"Thank you for your interest in our platform. To complete the registration process, please provide us with the following information."}),f.jsx(WL,{}),f.jsx(AO,{}),f.jsxs(HL,{children:["Already have account? ",f.jsx(qL,{to:"/signin",children:" Sign In"})]}),f.jsx(wy,{}),f.jsx(by,{})]})})}),KL=Q.div`
  width: 100%;
  max-width: 286px;
  display: flex;
  flex-direction: column;
...
`,n8=Q(ja)`
    ...
    font-weight: 400;
    line-height: 18px;
`,i8=()=>f.jsx(Yp,{children:f.jsx(Vn,{children:f.jsxs(e8,{children:[f.jsx("h2",{children:"Sign In"}),f.jsx(t8,{children:"Welcome! Please enter your credentials to login to the platform:"}),f.jsx(JL,{}),f.jsx(AO,{}),f.jsxs(r8,{children:["Don`t have an account? ",f.jsx(n8,{to:"/signup",children:"Sign Up"})]}),f.jsx(wy,{}),f.jsx(by,{})]})})}),a8=Q.div`
  display: flex;
  justify-content: center;
  align-items: center;
  flex-direction: column;
...
`,_W=Q.p`
  ...
  font-weight: 400;
  line-height: 18px;
`,$W=()=>f.jsx(PW,{children:f.jsxs(DW,{children:[f.jsx(jW,{children:f.jsx("svg",{width:"24",height:"24",children:f.jsx("use",{href:`${ge}#icon-attention`})})}),f.jsx(_W,{children:"We understand that each individual is unique, so the entire approach to diet is relative and tailored to your unique body and goals."})]})}),MW=()=>{var n,i;const{data:e}=Kl(),t=((n=e==null?void 0:e.profile)==null?void 0:n.DSN)||null,r=((i=e==null?void 0:e.profile)==null?void 0:i.BMR)||null;return f.jsxs(Vn,{children:[f.jsx(f8,{children:"Profile Settings"}),f.jsxs(h8,{children:[f.jsxs("div",{children:[f.jsx(p8,{name:e==null?void 0:e.name}),f.jsxs(v8,{children:[f.jsxs(Ob,{children:[f.jsxs("div",{children:[f.jsx("svg",{children:f.jsx("use",{href:`${ge}#icon-fork-knife`})}),f.jsx("p",{children:"Daily calorie intake"})]}),f.jsx(Tb,{children:r||"-"})]}),f.jsxs(Ob,{children:[f.jsxs("div",{children:[f.jsx("svg",{children:f.jsx("use",{href:`${ge}#icon-daily-dumbbell`})}),f.jsx("p",{children:"Daily norm of sports"})]}),f.jsxs(Tb,{children:[t||"- "," min"]})]})]}),f.jsx($W,{}),f.jsx(DC,{})]}),f.jsx(m8,{children:f.jsx(TW,{})})]})]})},wS=q.div`
...
`,Lu=16,af=({reverseOrder:e,position:t="top-center",toastOptions:r,gutter:n,children:i,containerStyle:a,containerClassName:o})=>{let{toasts:s,handlers:l}=sY(r);return C.createElement("div",{style:{position:"fixed",zIndex:9999,top:Lu,left:Lu,right:Lu,bottom:Lu,pointerEvents:"none",...a},className:o,onMouseEnter:l.startPause,onMouseLeave:l.endPause},s.map(u=>{let c=u.position||t,d=l.calculateOffset(u,{reverseOrder:e,gutter:n,defaultPosition:t}),p=_Y(c,d);return C.createElement(jY,{id:u.id,key:u.id,onHeightUpdate:l.updateHeight,className:u.visible?$Y:"",style:p},u.type==="custom"?Bd(u.message,u):i?i(u):C.createElement(DY,{toast:u,position:c}))}))},of=ur;const MY=e=>{const{title:t,consumeCalories:r,weight:n,recommended:i,category:a,_id:o,date:s}=e,l={itemid:o,date:s},[u,{isSuccess:c,isError:d}]=AT(),p=async()=>{await u(l)};return C.useEffect(()=>{c&&console.log("Product has been deleted"),d&&of.error("Product cannot delete!")},[u,c,d]),f.jsx(f.Fragment,{children:f.jsxs(_T,{children:[f.jsx(af,{}),f.jsxs(Ks,{children:[f.jsx(un,{children:"Title"}),f.jsx("div",{children:t})]}),f.jsxs(Ks,{children:[f.jsx(un,{children:"Category"}),f.jsx("div",{children:a})]}),f.jsxs($T,{children:[f.jsxs(MT,{children:[f.jsxs("span",{children:[f.jsx(un,{children:"Calories"}),f.jsx("div",{children:r})]}),f.jsxs("span",{children:[f.jsx(un,{children:"Weight"}),f.jsx("div",{children:n})]}),f.jsxs("span",{children:[f.jsx(un,{children:"Recommend"}),f.jsx(AW,{children:i?f.jsxs(f.Fragment,{children:[f.jsx(Yd,{isRecommended:i}),"Yes"]}):f.jsxs(f.Fragment,{children:[f.jsx(Yd,{isRecommended:i}),"No"]})})]})]}),f.jsx(rf,{handleDeleteProduct:p})]})]})})},RY=e=>{const{bodyPart:t,equipment:r,name:n,target:i,burnedCalories:a,time:o,_id:s,date:l}=e,u={itemid:s,date:l},[c,{isSuccess:d,isError:p}]=RT(),h=async()=>{await c(u)};return C.useEffect(()=>{d&&console.log("Exercis has been deleted"),p&&of.error("Exercis cannot delete!")},[c,d,p]),f.jsx(f.Fragment,{children:f.jsxs(_T,{children:[f.jsx(af,{}),f.jsxs(Ks,{children:[f.jsx(un,{children:"Body Part"}),f.jsx("div",{children:t})]}),f.jsxs(Ks,{children:[f.jsx(un,{children:"Equipment"}),f.jsx("div",{children:r})]}),f.jsxs(Ks,{children:[f.jsx(un,{children:"Name"}),f.jsx("div",{children:n})]}),f.jsxs($T,{children:[f.jsxs(MT,{children:[f.jsxs("span",{children:[f.jsx(un,{children:"Target"}),f.jsx(NW,{children:i})]}),f.jsxs("span",{children:[f.jsx(RW,{children:"Burned Calories"}),f.jsx("div",{children:a})]}),f.jsxs("span",{children:[f.jsx(un,{children:"Time"}),f.jsx("div",{children:o})]})]}),f.jsx(rf,{handleDeleteExercises:h})]})]})})},LT=q.div`
  display:flex;
  gap: 8px;
  margin-bottom:8px;
`,AY=q.div`
